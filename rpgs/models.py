...
class Rpg(models.Model):
    ...
    title = models.CharField(
        max_length=64, verbose_name='Name', help_text="The event's name")
    system = models.CharField(
        max_length=64, blank=True, help_text="The system that is being used")
    description = models.TextField(
        max_length=32768, blank=True, help_text="Longform description")
    timeslot = models.CharField(
        max_length=64, blank=True, help_text="The date/time(s) this event will occur")
    location = models.CharField(
        max_length=64, blank=True, help_text="The location where this event will occur")
    players_wanted = models.PositiveSmallIntegerField(
        validators=[validators.MinValueValidator(1)])
    is_in_the_past = models.BooleanField(
        default=False, help_text="Has the event already happened?")
    ...
    pinned = models.BooleanField(
        default=False, help_text='Pin this event to the top of the list')
    unlisted = models.BooleanField(
        default=False, help_text='Prevent this from appearing on the events listing')
    ...
    members = models.ManyToManyField(
        Member, blank=True, help_text="The people playing the game")
    ...
    messaging_thread = models.ForeignKey(
